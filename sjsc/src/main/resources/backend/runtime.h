...
#define BOX_TAG 0x2
#define STR_TAG 0x0 // NOTE: Currently unused
#define CLS_TAG 0x6 // NOTE: Currently unused
...
#define INVOKE_CLOSURE(f, ...) ((f)->func((f)->env, ##__VA_ARGS__))
#define PIVOT_INVOKE_CLOSURE(T, f, ...) (((T)((old_closure_t*)f)->func)(((old_closure_t*)f)->env, ##__VA_ARGS__))
#define NEW_INVOKE_CLOSURE(T, f, ...) (((T)(((closure_t*)f)->code.ptr))(((env_t)(((closure_t*)f)->env.ptr), ##__VA_ARGS__))
...
void* closure_alloc_prim(void* env, void* code);
void* ctor_alloc_prim(void* env, void* code, void* proto);
#ifdef __cplusplus
}
#endif

#define ALLOC_CLOSURE(fptr, n, ...) (closure_alloc_prim(env_alloc_prim(n, ##__VA_ARGS__), fptr))
#define ALLOC_CTOR_CLOSURE(fptr, proto, n, ...) (ctor_alloc_prim(env_alloc_prim(n, ##__VA_ARGS__), fptr, proto))
...
#define OBJECT_CLOSURE 0x1 // function, method, constructor
#define OBJECT_STRING  0x2 // strings
#define OBJECT_OBJECT  0x3 // objects, maps
#define OBJECT_ARRAY   0x4 // arrays
...
typedef struct type_tag {
    char tag; // OBJECT_*
    union {
        struct type_tag *array_elem; // single pointer
...
typedef struct code_type {
    ...
    struct type_tag args[]; // includes receiver in args[0] for method/ctor
} code_type_t;
...
extern "C" {
#endif
object_t* alloc_object_lit(object_map vtbl, int nfields, ...);
object_t* construct_object(object_map vtbl, object_t* proto, int nslots);
#ifdef __cplusplus
}
#endif
