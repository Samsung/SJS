...
public abstract class CBackend extends IRVisitor<CNode> {
    ...
    protected int str_const_cnt = 0;
    protected IRFieldCollector.FieldMapping field_codes;
    protected com.samsung.sjs.backend.asts.c.CompoundStatement string_literal_decls = null;
    ...
    public com.samsung.sjs.backend.asts.c.Statement visitExpressionStatement(com.samsung.sjs.backend.asts.ir.ExpressionStatement node) {
        ...
        if (result instanceof com.samsung.sjs.backend.asts.c.Expression) {
            ...
            return new com.samsung.sjs.backend.asts.c.ExpressionStatement(result.asExpression());
        } else {
