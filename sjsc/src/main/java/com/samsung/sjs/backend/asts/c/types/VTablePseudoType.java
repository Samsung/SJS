 ...
 * represent object slot offset maps
 *
 * @author colin.gordon
 */
...
// in generated code.
public final class VTablePseudoType extends CType {
    public String toSource() { return "object_map"; }
    public VTablePseudoType() { super(1); }
}
