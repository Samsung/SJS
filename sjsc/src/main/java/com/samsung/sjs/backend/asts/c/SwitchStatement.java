...
public class SwitchStatement extends Statement {
    ...
    public SwitchStatement(Expression disc) {
        discriminee = disc;
        cases = new LinkedList<>();
    }

    public Expression getDiscriminee() { return discriminee; }
    public void addCaseStatement(CaseStatement c) { cases.add(c); }
    public List<CaseStatement> getCaseStatements() { return cases; }
