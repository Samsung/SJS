...
if [ -e "$BASE" ]; then
    ...
    ./sjsc --only-c calc.js --extra-decls idl/tizen.json --native-libs idl/tizen.linkage.json --guest-runtime
    cp src/main/resources/backend/*.h $1/inc/
    cp external/gc/native/include/gc.h $1/inc/
    cp -r external/gc/native/include/gc $1/inc/
    cp calc.c $1/src/calc.c
    cp calc.h $1/inc/calc.h
    # !!! TODO: this tizen.cpp has a hardcoded path to a calc.h....
    # modify glue generation to refer to "app" .h?
    cp idl/tizen.cpp $1/src/
    make -C src/main/resources/backend/ emulator tizen
    cp src/main/resources/backend/sjs_runtime.emulator.a $1/lib/
    cp src/main/resources/backend/sjs_runtime.tizen.a $1/lib/
else
